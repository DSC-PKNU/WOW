...
package com.example.mapbox_navi
...
import com.example.mapbox_navi.databinding.ItemProbabilityBinding
import com.example.mapbox_navi.soundclassifier.databinding.ItemProbabilityBinding.*
...
internal class ProbabilitiesAdapter : RecyclerView.Adapter<ProbabilitiesAdapter.ViewHolder>() {
  var labelList = emptyList1<String>()
